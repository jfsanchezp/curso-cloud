...
public class ReservasCommandEndpointV2 {
	...
	public ReservasCommandEndpointV2( SyncCommandBus syncCommandBus, CommandBus commandBus, ReservasModelAssemblerV2 reservasModelAssembler,
	...
	public ReservaVueloDTO creaReserva( @RequestHeader( name = "UMU-Usuario", required = true ) String usuario, @RequestBody @Valid ReservaVueloDTO nuevaReservaVuelo ) throws Exception {
		return reservasModelAssembler.toModel( syncCommandBus.handle( CrearReservaCommand.of( authService.parseUserHeader( usuario ), nuevaReservaVuelo.getVuelo().getId(),
	...
	public void cancelarReserva( @RequestHeader( name = "UMU-Usuario", required = true ) String usuario, @PathVariable( "idReserva" ) UUID idReserva ) throws Exception {
		commandBus.handle( CancelarReservaCommand.of( authService.parseUserHeader( usuario ), idReserva ) ) ;
	}
}
