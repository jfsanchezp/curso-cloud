...
public class VuelosQueryEndpointV2 {
	...
	public VuelosQueryEndpointV2( QueryBus queryBus, VuelosModelAssemblerV2 vuelosModelAssemblerV2, PagedResourcesAssembler<VueloAmpliadoDTO> pagedResourcesAssembler,
	...
	public CollectionModel<VueloDTO> getVuelos( @RequestHeader( name = "UMU-Usuario", required = true ) String usuario, @RequestParam( name = "page", defaultValue = "0" ) int page, @RequestParam( name = "size", defaultValue = "25" ) int size )
		...
		return pagedResourcesAssembler.toModel( queryBus.handle( ListaVuelosQuery.of( documento, page, size ) ), vuelosModelAssemblerV2 );
	}
	...
	public VueloDTO getVuelo( @RequestHeader( name = "UMU-Usuario", required = true ) String usuario, @PathVariable( "idVuelo" ) UUID idVuelo ) throws Exception {
		return vuelosModelAssemblerV2.toModel( queryBus.handle( ObtenerVueloQuery.of( authService.parseUserHeader( usuario ), idVuelo ) ) );
	}
