...
@Component
public class CancelarReservaVueloKOConsumer {

	private final ReservasVueloWriteRepository reservasVueloWriteRepository;

	public CancelarReservaVueloKOConsumer( ReservasVueloWriteRepository reservasVueloWriteRepository) {
	...
	@EventListener
	@Transactional
	public void accept(CancelarReservaVueloKOEvent event)
	{
